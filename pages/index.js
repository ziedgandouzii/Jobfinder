...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Job Finder | Find Right Jobs</title>
        ...
        <meta name="keywords" content="job Finder, job search, career opportunities, employment, job listings, job openings, job vacancies, job postings, hiring, recruitment" />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Zied  Gandouzi" />
        <meta property="og:title" content="FIND Right Jobs | Job Finder" />
        <meta name="twitter:title" content="FIND Right Jobs | Job Finder" />
